...
If you would like to create a new SPQR package, you must first download the spqrPackage (you need to download this whole file and should run all commands in the spqrPackage directory). We used this YouTube video as a reference for how to upload the package: https://www.youtube.com/watch?v=5KEObONUkik.
